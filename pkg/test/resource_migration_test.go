...
func TestResourceMigration_CrunchbaseMigration(t *testing.T) {
	...
	//		}
	//
	//		var records = util.ArrayMap(list.Content, func(record unstructured.Unstructured) unstructured.Unstructured {
	//
	//			return record
	//		})
	//
	...
	//			Resource: resource2.Name,
	//			Ids: util.ArrayMap(list.Content, func(record unstructured.Unstructured) string {
	//				return record.Id
	//			}),
	//		})
	//
