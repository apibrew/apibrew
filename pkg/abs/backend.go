...
type BackendActionExecutor interface {
	ExecuteAction(ctx context.Context, resource *model.Resource, rec *model.Record, actionName string, input unstructured.Unstructured) (unstructured.Unstructured, errors.ServiceError)
}
