...
var file_openapiv3_annotations_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*openapiv3.Schema)(nil),
		Field:         1143,
		Name:          "openapi.v3.value",
		Tag:           "bytes,1143,opt,name=value",
		Filename:      "openapiv3/annotations.proto",
	},
}
...
var (
	// optional openapi.v3.Schema value = 1143;
	E_Value = &file_openapiv3_annotations_proto_extTypes[4]
)
...
var file_openapiv3_annotations_proto_rawDesc = []byte{
	...
	0x61, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x3a, 0x4c, 0x0a, 0x05, 0x76,
	...
	0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0xf7, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12,
	0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x33, 0x2e, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x54, 0x0a, 0x0e, 0x6f, 0x72, 0x67,
	0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x5f, 0x76, 0x33, 0x42, 0x10, 0x41, 0x6e, 0x6e,
	...
	0x70, 0x6b, 0x67, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0xa2, 0x02, 0x03, 0x4f, 0x41, 0x53, 0x62,
...
var file_openapiv3_annotations_proto_goTypes = []interface{}{
	...
	(*openapiv3.Document)(nil),            // 5: openapi.v3.Document
	(*openapiv3.Operation)(nil),           // 6: openapi.v3.Operation
	(*openapiv3.Schema)(nil),              // 7: openapi.v3.Schema
}
var file_openapiv3_annotations_proto_depIdxs = []int32{
	...
	4,  // 4: openapi.v3.value:extendee -> google.protobuf.EnumValueOptions
	5,  // 5: openapi.v3.document:type_name -> openapi.v3.Document
	6,  // 6: openapi.v3.operation:type_name -> openapi.v3.Operation
	7,  // 7: openapi.v3.schema:type_name -> openapi.v3.Schema
	7,  // 8: openapi.v3.property:type_name -> openapi.v3.Schema
	7,  // 9: openapi.v3.value:type_name -> openapi.v3.Schema
