...
func (s RecordInlineSelector) SelectRecords(ctx context.Context, resource *model.Resource, records *[]unstructured.Unstructured, selector *resource_model.BooleanExpression) ([]unstructured.Unstructured, errors.ServiceError) {
...
func (s RecordInlineSelector) EvaluateRecord(ctx context.Context, resource *model.Resource, record unstructured.Unstructured, selector *resource_model.BooleanExpression) (bool, errors.ServiceError) {
	if selector.And != nil {
...
func (s RecordInlineSelector) resolve(resource *model.Resource, record unstructured.Unstructured, than *resource_model.PairExpression) (unstructured.Any, unstructured.Any, *model.ResourceProperty, errors.ServiceError) {
