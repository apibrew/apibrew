...
func (s *User) GetBackend() UserBackendType {
	return s.Backend
}

func (s *User) GetOptions() map[string]string {
	return s.Options
}

func (s *User) ToRecord() *model.Record {
...
func (s *User) FromRecord(record *model.Record) {
	s.FromProperties(record.Properties)
}

func (s *User) FromProperties(properties map[string]*structpb.Value) {
	...
	if properties["backend"] != nil {
		...
		s.Backend = UserBackendType(val.(string))
...
func (s *User) ToProperties() map[string]*structpb.Value {
...
func (s *User) GetResourceName() string {
	return "data-source"
}

func (s *User) GetNamespace() string {
	return "system"
}
...
func (s *User) Same(other *User) bool {
