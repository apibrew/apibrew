...
func (p sqliteBackendOptions) TypeModifier(propertyType model.ResourceProperty_Type) types.PropertyType {
...
func (p sqliteBackendOptions) GetSqlTypeFromProperty(propertyType model.ResourceProperty_Type, length uint32) string {
	switch propertyType {
...
func (p sqliteBackendOptions) GetPropertyTypeFromPsql(columnType string) model.ResourceProperty_Type {
	switch columnType {
	case "bool":
