...
var RoleResource = &model.Resource{
	...
	Properties: []*model.ResourceProperty{
		...
		},
		{
			...
			ExampleValue: structpb.NewStructValue(&structpb.Struct{Fields: map[string]*structpb.Value{"updatedBy": structpb.NewStringValue("admin"), "createdOn": structpb.NewStringValue("2023-11-04T03:41:26+04:00"), "updatedOn": structpb.NewStringValue("2023-11-04T03:41:26+04:00"), "createdBy": structpb.NewStringValue("admin")}}),
