...
const (
	DataSource_Create_FullMethodName                    = "/stub.DataSource/Create"
	DataSource_List_FullMethodName                      = "/stub.DataSource/List"
	DataSource_Update_FullMethodName                    = "/stub.DataSource/Update"
	DataSource_Delete_FullMethodName                    = "/stub.DataSource/Delete"
	DataSource_Get_FullMethodName                       = "/stub.DataSource/Get"
...
func (c *dataSourceClient) Create(ctx context.Context, in *CreateDataSourceRequest, opts ...grpc.CallOption) (*CreateDataSourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataSource_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataSourceClient) Delete(ctx context.Context, in *DeleteDataSourceRequest, opts ...grpc.CallOption) (*DeleteDataSourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataSource_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DataSource_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataSource_Create_FullMethodName,
	}
...
func _DataSource_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataSource_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
