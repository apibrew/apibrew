...
var (
	filter_Record_Create_0 = &utilities.DoubleArray{Encoding: map[string]int{"properties": 0, "namespace": 1, "resource": 2}, Base: []int{1, 2, 4, 6, 0, 0, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 2, 3, 3, 4, 4}}
)
...
func request_Record_Create_0(ctx context.Context, marshaler runtime.Marshaler, client RecordClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.Properties); err != nil && err != io.EOF {
...
var (
	filter_Record_Apply_0 = &utilities.DoubleArray{Encoding: map[string]int{"properties": 0, "namespace": 1, "resource": 2}, Base: []int{1, 2, 4, 6, 0, 0, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 2, 3, 3, 4, 4}}
)
...
var (
	filter_Record_Delete_0 = &utilities.DoubleArray{Encoding: map[string]int{"namespace": 0, "resource": 1, "id": 2}, Base: []int{1, 2, 4, 6, 0, 0, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 2, 3, 3, 4, 4}}
)
...
func RegisterRecordHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RecordServer) error {
	...
	mux.Handle("POST", pattern_Record_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/rest.Record/Create", runtime.WithHTTPPathPattern("/records/{namespace}/{resource}"))
		if err != nil {
		...
		forward_Record_Create_0(annotatedContext, mux, outboundMarshaler, w, req, response_Record_Create_0{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PUT", pattern_Record_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Record_Update_0(annotatedContext, mux, outboundMarshaler, w, req, response_Record_Update_0{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PATCH", pattern_Record_Apply_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/rest.Record/Apply", runtime.WithHTTPPathPattern("/records/{namespace}/{resource}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		...
		forward_Record_Apply_0(annotatedContext, mux, outboundMarshaler, w, req, response_Record_Apply_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterRecordHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RecordClient) error {
	...
	mux.Handle("POST", pattern_Record_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rest.Record/Create", runtime.WithHTTPPathPattern("/records/{namespace}/{resource}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_Record_Apply_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rest.Record/Apply", runtime.WithHTTPPathPattern("/records/{namespace}/{resource}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_Record_Create_0 struct {
	proto.Message
}

func (m response_Record_Create_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*CreateRecordResponse)
	return response.Properties
}

type response_Record_Update_0 struct {
	proto.Message
}

func (m response_Record_Update_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*UpdateRecordResponse)
	return response.Properties
}

type response_Record_Apply_0 struct {
	proto.Message
}

func (m response_Record_Apply_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*ApplyRecordResponse)
	return response.Properties
}
...
var (
	...
	pattern_Record_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"records", "namespace", "resource", "id"}, ""))
)
