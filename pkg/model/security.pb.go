...
type SecurityConstraint struct {
	...
	PropertyValue string        `protobuf:"bytes,4,opt,name=propertyValue,proto3" json:"propertyValue,omitempty"`                    // property value where it will be applied
	...
	// user part
	Username    string     `protobuf:"bytes,7,opt,name=username,proto3" json:"username,omitempty"`                     // username which it is applied to
	Role        string     `protobuf:"bytes,8,opt,name=role,proto3" json:"role,omitempty"`                             // role which it is applied to
	RequirePass bool       `protobuf:"varint,10,opt,name=requirePass,proto3" json:"requirePass,omitempty"`             // if yes, if this rule passes match part, it will be required to match remaining parts also, if not, it will cause rejection
...
func (x *SecurityConstraint) GetRequirePass() bool {
	if x != nil {
		return x.RequirePass
	}
	return false
}
...
var file_model_security_proto_rawDesc = []byte{
	...
	0xc5, 0x03, 0x0a, 0x12, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x43, 0x6f, 0x6e, 0x73,
	...
	0x28, 0x09, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x12, 0x24, 0x0a, 0x0d,
	0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0d, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x49, 0x64, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x63, 0x6f, 0x72,
	0x64, 0x49, 0x64, 0x73, 0x12, 0x32, 0x0a, 0x06, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x18, 0x05,
	...
	,
	...
	0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x10, 0x02, 0x12, 0x19, 0x0a, 0x15, 0x4f, 0x50, 0x45, 0x52,
	0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54,
	0x45, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x55, 0x4c, 0x4c, 0x10, 0x04, 0x2a, 0x3b, 0x0a,
	0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x15, 0x0a, 0x11, 0x50,
	0x45, 0x52, 0x4d, 0x49, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x41, 0x4c, 0x4c, 0x4f, 0x57,
	0x10, 0x00, 0x12, 0x16, 0x0a, 0x12, 0x50, 0x45, 0x52, 0x4d, 0x49, 0x54, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x10, 0x01, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69,
...
var file_model_security_proto_depIdxs = []int32{
	0, // 0: model.SecurityConstraint.operation:type_name -> model.OperationType
	3, // 1: model.SecurityConstraint.before:type_name -> google.protobuf.Timestamp
	3, // 2: model.SecurityConstraint.after:type_name -> google.protobuf.Timestamp
