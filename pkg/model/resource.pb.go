...
type ResourceProperty struct {
	...
	Virtual       bool              `protobuf:"varint,10,opt,name=virtual,proto3" json:"virtual,omitempty"`                  // virtual is to mark property as virtual. Virtual properties are not stored on backend. They are calculated on the fly
...
func (x *ResourceProperty) GetVirtual() bool {
	if x != nil {
		return x.Virtual
	}
	return false
...
var file_model_resource_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x07, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x12, 0x3f, 0x0a, 0x0c, 0x64, 0x65, 0x66,
