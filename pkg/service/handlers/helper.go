...
func prepareStdHandler(order int, action core.Event_Action, handlerFunc backend_event_handler.HandlerFunc, resource *model.Resource) backend_event_handler.Handler {
	...
	return backend_event_handler.Handler{
		...
		Selector: &core.EventSelector{
			Actions:    []core.Event_Action{action},
