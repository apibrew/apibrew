...
//func (r *recordResolver) expandRecordsReferences(ctx context.Context, records []*model.Record, property *model.ResourceProperty) errors.ServiceError {
//	var referencedResource, _ = r.resourceService.GetResourceByName(util.WithSystemContext(ctx), property.Reference.Namespace, reference.Property.Reference.Resource)
//
//	var query *model.BooleanExpression
//
