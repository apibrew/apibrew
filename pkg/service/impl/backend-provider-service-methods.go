...
func (b backendProviderService) BeginTransaction(ctx context.Context, dataSourceName string, readOnly bool) (transactionKey string, serviceError errors.ServiceError) {
	bck, err := b.getBackendByDataSourceName(ctx, dataSourceName)
	...
	return bck.BeginTransaction(ctx, readOnly)
}

func (b backendProviderService) CommitTransaction(ctx context.Context, dataSourceName string) (serviceError errors.ServiceError) {
	bck, err := b.getBackendByDataSourceName(ctx, dataSourceName)
	...
	return bck.CommitTransaction(ctx)
}

func (b backendProviderService) RollbackTransaction(ctx context.Context, dataSourceName string) (serviceError errors.ServiceError) {
	bck, err := b.getBackendByDataSourceName(ctx, dataSourceName)
	...
	return bck.RollbackTransaction(ctx)
}

func (b backendProviderService) IsTransactionAlive(ctx context.Context, dataSourceName string) (isAlive bool, serviceError errors.ServiceError) {
	bck, err := b.getBackendByDataSourceName(ctx, dataSourceName)
	...
	return bck.IsTransactionAlive(ctx)
}
