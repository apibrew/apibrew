...
type DataSourceBackendType string

const (
	DataSourceBackendType_POSTGRESQL DataSourceBackendType = "POSTGRESQL"
	DataSourceBackendType_MYSQL      DataSourceBackendType = "MYSQL"
	DataSourceBackendType_MONGODB    DataSourceBackendType = "MONGODB"
	DataSourceBackendType_REDIS      DataSourceBackendType = "REDIS"
)
...
func (s *DataSource) GetId() string {
	return s.Id
}
...
func (s *DataSource) GetBackend() DataSourceBackendType {
	return s.Backend
}
...
func (s *DataSource) ToRecord() *model.Record {
...
func (s *DataSource) FromRecord(record *model.Record) {
	s.FromProperties(record.Properties)
}

func (s *DataSource) FromProperties(properties map[string]*structpb.Value) {
	...
	if properties["backend"] != nil {
		...
		s.Backend = DataSourceBackendType(val.(string))
...
func (s *DataSource) ToProperties() map[string]*structpb.Value {
...
func (s *DataSource) GetResourceName() string {
	return "data-source"
}

func (s *DataSource) GetNamespace() string {
	return "system"
}

func (s *DataSource) Equals(other *DataSource) bool {
	return reflect.DeepEqual(s, other)
}

func (s *DataSource) Same(other *DataSource) bool {
