...
var ErrorHandlerContext = React.createContext(undefined);
...
function useResourceById(id) {
  ...
  var client = useClient();
  useEffect(function () {
    client.listResources().then(function (response) {
      ...
      if (resource) {
        ...
        throw new ApiException(Code.RESOURCE_NOT_FOUND, "Resource with id " + id + " not found");
      }
    }, errorHandler);
  }, [id]);
  return resource;
        ...
        return Promise.resolve(_for(function () {
          ...
          return _finallyRethrows(function () {
            return _catch(function () {
              ...
              return Promise.resolve(fetch(Urls.recordWatchUrl(client.getUrl(), entityInfo.restPath, filters), {
                method: 'GET',
                headers: _extends({
...
function useQueryListParams(defaultValues) {
  ...
  var _useState = useState(_extends({}, defaultValues, prepareListRecordParamsFromQuerySearch(searchParams))),
...
export { ClientConsumer, ClientContext, ClientProvider, ErrorHandlerContext, LocalStorageTokenStorage, cloudConnectionProvider, useAxios, useClient, useErrorHandler, useQueryListParams, useRecordBy, useRecordByName, useRecords, useRepository, useResourceById, useResourceByName, useTokenBody, useWatcher };
