...
public class User extends Entity {
    ...
    private User.AuditData auditData;
    ...
    public User.AuditData getAuditData() {
        return auditData;
    }

    public void setAuditData(User.AuditData auditData) {
        this.auditData = auditData;
    }

    public User withAuditData(User.AuditData auditData) {
        this.auditData = auditData;
