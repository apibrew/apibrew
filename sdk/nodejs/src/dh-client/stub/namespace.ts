...
export class ListNamespaceResponse extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        content?: dependency_1.Namespace[];
    }) {
        super();
    ...
    get content() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.Namespace, 2) as dependency_1.Namespace[];
    }
    set content(value: dependency_1.Namespace[]) {
        pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    static fromObject(data: {
        content?: ReturnType<typeof dependency_1.Namespace.prototype.toObject>[];
    }): ListNamespaceResponse {
        const message = new ListNamespaceResponse({});
        if (data.content != null) {
            message.content = data.content.map(item => dependency_1.Namespace.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.content != null) {
            data.content = this.content.map((item: dependency_1.Namespace) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.content.length)
            writer.writeRepeatedMessage(2, this.content, (item: dependency_1.Namespace) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ListNamespaceResponse {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 2:
                    reader.readMessage(message.content, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.Namespace.deserialize(reader), dependency_1.Namespace));
                    break;
                default: reader.skipField();
            }
        }
...
export class CreateNamespaceRequest extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        token?: string;
        Namespaces?: dependency_1.Namespace[];
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], this.#one_of_decls);
        if (!Array.isArray(data) && typeof data == "object") {
    ...
    set Namespaces(value: dependency_1.Namespace[]) {
        pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    static fromObject(data: {
        token?: string;
        Namespaces?: ReturnType<typeof dependency_1.Namespace.prototype.toObject>[];
        ...
        if (data.Namespaces != null) {
            message.Namespaces = data.Namespaces.map(item => dependency_1.Namespace.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.Namespaces != null) {
            data.Namespaces = this.Namespaces.map((item: dependency_1.Namespace) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.Namespaces.length)
            writer.writeRepeatedMessage(2, this.Namespaces, (item: dependency_1.Namespace) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.Namespaces, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.Namespace.deserialize(reader), dependency_1.Namespace));
                    break;
                default: reader.skipField();
            }
        }
...
export class CreateNamespaceResponse extends pb_1.Message {
    ...
    get Namespaces() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.Namespace, 1) as dependency_1.Namespace[];
    }
    set Namespaces(value: dependency_1.Namespace[]) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.Namespaces.length)
            writer.writeRepeatedMessage(1, this.Namespaces, (item: dependency_1.Namespace) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreateNamespaceResponse {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.Namespaces, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_1.Namespace.deserialize(reader), dependency_1.Namespace));
                    break;
                default: reader.skipField();
            }
        }
...
export class GetNamespaceResponse extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        Namespace?: dependency_1.Namespace;
    }) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        if (!Array.isArray(data) && typeof data == "object") {
    ...
    get Namespace() {
        return pb_1.Message.getWrapperField(this, dependency_1.Namespace, 1) as dependency_1.Namespace;
    }
    set Namespace(value: dependency_1.Namespace) {
    ...
    static fromObject(data: {
        Namespace?: ReturnType<typeof dependency_1.Namespace.prototype.toObject>;
    }): GetNamespaceResponse {
        const message = new GetNamespaceResponse({});
        if (data.Namespace != null) {
            message.Namespace = dependency_1.Namespace.fromObject(data.Namespace);
        }
        return message;
    }
    toObject() {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetNamespaceResponse {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.Namespace, () => message.Namespace = dependency_1.Namespace.deserialize(reader));
                    break;
                default: reader.skipField();
            }
        }
