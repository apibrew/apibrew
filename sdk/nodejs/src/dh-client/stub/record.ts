...
export class ListRecordResponse extends pb_1.Message {
    ...
    get content() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.Record, 2) as dependency_1.Record[];
    }
    set content(value: dependency_1.Record[]) {
        pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    static fromObject(data: {
        total?: number;
        content?: ReturnType<typeof dependency_1.Record.prototype.toObject>[];
    }): ListRecordResponse {
        ...
        if (data.content != null) {
            message.content = data.content.map(item => dependency_1.Record.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.content != null) {
            data.content = this.content.map((item: dependency_1.Record) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.content.length)
            writer.writeRepeatedMessage(2, this.content, (item: dependency_1.Record) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.content, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.Record.deserialize(reader), dependency_1.Record));
                    break;
                default: reader.skipField();
            }
        }
...
export class SearchRecordRequest extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        namespace?: string;
        resource?: string;
        query?: dependency_2.BooleanExpression;
        limit?: number;
        offset?: number;
        useHistory?: boolean;
        resolveReferences?: string[];
    ...
    get query() {
        return pb_1.Message.getWrapperField(this, dependency_2.BooleanExpression, 4) as dependency_2.BooleanExpression;
    }
    set query(value: dependency_2.BooleanExpression) {
    ...
    static fromObject(data: {
        ...
        namespace?: string;
        resource?: string;
        query?: ReturnType<typeof dependency_2.BooleanExpression.prototype.toObject>;
        limit?: number;
        offset?: number;
        useHistory?: boolean;
        resolveReferences?: string[];
        ...
        if (data.query != null) {
            message.query = dependency_2.BooleanExpression.fromObject(data.query);
        }
        if (data.limit != null) {
            message.limit = data.limit;
        }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    reader.readMessage(message.query, () => message.query = dependency_2.BooleanExpression.deserialize(reader));
                    break;
                case 5:
                    message.limit = reader.readUint32();
                    break;
...
export class CreateRecordRequest extends pb_1.Message {
    ...
    get record() {
        return pb_1.Message.getWrapperField(this, dependency_1.Record, 4) as dependency_1.Record;
    }
    ...
    get records() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.Record, 5) as dependency_1.Record[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.records.length)
            writer.writeRepeatedMessage(5, this.records, (item: dependency_1.Record) => item.serialize(writer));
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    reader.readMessage(message.records, () => pb_1.Message.addToRepeatedWrapperField(message, 5, dependency_1.Record.deserialize(reader), dependency_1.Record));
                    break;
                case 6:
...
export class CreateRecordResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.records.length)
            writer.writeRepeatedMessage(2, this.records, (item: dependency_1.Record) => item.serialize(writer));
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.records, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.Record.deserialize(reader), dependency_1.Record));
                    break;
                case 4:
...
export class UpdateMultiRecordRequest extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        resource?: string;
        query?: dependency_2.BooleanExpression;
        properties?: Map<string, dependency_5.Value>;
        annotations?: Map<string, string>;
    }) {
        super();
    ...
    get properties() {
        return pb_1.Message.getField(this, 5) as any as Map<string, dependency_5.Value>;
    }
    set properties(value: Map<string, dependency_5.Value>) {
    ...
    static fromObject(data: {
        ...
        query?: ReturnType<typeof dependency_2.BooleanExpression.prototype.toObject>;
        properties?: {
            [key: string]: ReturnType<typeof dependency_5.Value.prototype.toObject>;
        };
        annotations?: {
            [key: string]: string;
        };
        ...
        if (typeof data.properties == "object") {
            message.properties = new Map(Object.entries(data.properties).map(([key, value]) => [key, dependency_5.Value.fromObject(value)]));
        }
        if (typeof data.annotations == "object") {
            message.annotations = new Map(Object.entries(data.annotations));
        }
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 5:
                    reader.readMessage(message, () => pb_1.Map.deserializeBinary(message.properties as any, reader, reader.readString, () => {
                        let value;
                        reader.readMessage(message, () => value = dependency_5.Value.deserialize(reader));
                        return value;
                    }));
                    break;
                case 103:
...
export abstract class UnimplementedRecordService {
    static definition = {
        ...
        ReadStream: {
            ...
            responseSerialize: (message: dependency_1.Record) => Buffer.from(message.serialize()),
            responseDeserialize: (bytes: Buffer) => dependency_1.Record.deserialize(new Uint8Array(bytes))
        },
        WriteStream: {
            path: "/stub.Record/WriteStream",
            requestStream: true,
            responseStream: false,
            requestSerialize: (message: dependency_1.Record) => Buffer.from(message.serialize()),
            requestDeserialize: (bytes: Buffer) => dependency_1.Record.deserialize(new Uint8Array(bytes)),
    ...
    abstract ReadStream(call: grpc_1.ServerWritableStream<ReadStreamRequest, dependency_1.Record>): void;
    abstract WriteStream(call: grpc_1.ServerReadableStream<dependency_1.Record, WriteStreamResponse>, callback: grpc_1.sendUnaryData<WriteStreamResponse>): void;
...
export class RecordClient extends grpc_1.makeGenericClientConstructor(UnimplementedRecordService.definition, "Record", {}) {
    ...
    WriteStream: GrpWritableServiceInterface<dependency_1.Record, WriteStreamResponse> = (metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<WriteStreamResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<WriteStreamResponse>, callback?: grpc_1.requestCallback<WriteStreamResponse>): grpc_1.ClientWritableStream<dependency_1.Record> => {
