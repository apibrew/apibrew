...
export class WatchRequest extends pb_1.Message {
    ...
    get events() {
        return pb_1.Message.getFieldWithDefault(this, 5, []) as dependency_1.EventType[];
    }
    set events(value: dependency_1.EventType[]) {
...
export abstract class UnimplementedWatchService {
    static definition = {
        Watch: {
            ...
            responseSerialize: (message: dependency_1.WatchMessage) => Buffer.from(message.serialize()),
            responseDeserialize: (bytes: Buffer) => dependency_1.WatchMessage.deserialize(new Uint8Array(bytes))
        }
    };
    [method: string]: grpc_1.UntypedHandleCall;
    abstract Watch(call: grpc_1.ServerWritableStream<WatchRequest, dependency_1.WatchMessage>): void;
}
