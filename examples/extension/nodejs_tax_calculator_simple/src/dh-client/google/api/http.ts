...
export class Http extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("fullyDecodeReservedExpansion" in data && data.fullyDecodeReservedExpansion != undefined) {
                this.fullyDecodeReservedExpansion = data.fullyDecodeReservedExpansion;
            }
        }
    }
    get rules() {
    ...
    static fromObject(data: {
        ...
        if (data.fullyDecodeReservedExpansion != null) {
            message.fullyDecodeReservedExpansion = data.fullyDecodeReservedExpansion;
        }
        return message;
    }
    toObject() {
        ...
        if (this.fullyDecodeReservedExpansion != null) {
            data.fullyDecodeReservedExpansion = this.fullyDecodeReservedExpansion;
        }
        return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.fullyDecodeReservedExpansion != false)
            writer.writeBool(2, this.fullyDecodeReservedExpansion);
        if (!w)
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    message.fullyDecodeReservedExpansion = reader.readBool();
                    break;
...
export class HttpRule extends pb_1.Message {
    ...
    constructor(data?: any[] | ({
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("additionalBindings" in data && data.additionalBindings != undefined) {
                this.additionalBindings = data.additionalBindings;
            }
        }
    }
    get selector() {
    ...
    set additionalBindings(value: HttpRule[]) {
    ...
    static fromObject(data: {
        ...
        body?: string;
        responseBody?: string;
        additionalBindings?: ReturnType<typeof HttpRule.prototype.toObject>[];
    }): HttpRule {
        ...
        if (data.additionalBindings != null) {
            message.additionalBindings = data.additionalBindings.map(item => HttpRule.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.additionalBindings != null) {
            data.additionalBindings = this.additionalBindings.map((item: HttpRule) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.responseBody.length)
            writer.writeString(12, this.responseBody);
        if (this.additionalBindings.length)
            writer.writeRepeatedMessage(11, this.additionalBindings, (item: HttpRule) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 7:
                    ...
                    break;
                case 12:
                    message.responseBody = reader.readString();
                    break;
                case 11:
                    reader.readMessage(message.additionalBindings, () => pb_1.Message.addToRepeatedWrapperField(message, 11, HttpRule.deserialize(reader), HttpRule));
                    break;
                default: reader.skipField();
            }
        }
