...
export class ResourceMigrationPlan extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        existingResource?: dependency_2.Resource;
        currentResource?: dependency_2.Resource;
    ...
    set existingResource(value: dependency_2.Resource) {
        pb_1.Message.setWrapperField(this, 1, value);
    }
    get hasExistingResource() {
        return pb_1.Message.getField(this, 1) != null;
    }
    get currentResource() {
        return pb_1.Message.getWrapperField(this, dependency_2.Resource, 2) as dependency_2.Resource;
    }
    set currentResource(value: dependency_2.Resource) {
        pb_1.Message.setWrapperField(this, 2, value);
    }
    get hasCurrentResource() {
        return pb_1.Message.getField(this, 2) != null;
    }
    get steps() {
    ...
    static fromObject(data: {
        existingResource?: ReturnType<typeof dependency_2.Resource.prototype.toObject>;
        currentResource?: ReturnType<typeof dependency_2.Resource.prototype.toObject>;
        ...
        if (data.existingResource != null) {
            message.existingResource = dependency_2.Resource.fromObject(data.existingResource);
        }
        if (data.currentResource != null) {
            message.currentResource = dependency_2.Resource.fromObject(data.currentResource);
        }
        if (data.steps != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ResourceMigrationPlan {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.existingResource, () => message.existingResource = dependency_2.Resource.deserialize(reader));
                    break;
                case 2:
                    reader.readMessage(message.currentResource, () => message.currentResource = dependency_2.Resource.deserialize(reader));
                    break;
                case 3:
