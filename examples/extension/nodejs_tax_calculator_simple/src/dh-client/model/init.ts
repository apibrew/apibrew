...
export namespace model {
    ...
    export class InitData extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            config?: AppConfig;
            systemDataSource?: dependency_1.model.DataSource;
            systemNamespace?: dependency_5.model.Namespace;
            initDataSources?: dependency_1.model.DataSource[];
            initNamespaces?: dependency_5.model.Namespace[];
            initUsers?: dependency_2.model.User[];
            initResources?: dependency_3.model.Resource[];
            initRecords?: dependency_4.model.Record[];
        }) {
            super();
        ...
        get systemDataSource() {
            return pb_1.Message.getWrapperField(this, dependency_1.model.DataSource, 2) as dependency_1.model.DataSource;
        }
        set systemDataSource(value: dependency_1.model.DataSource) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        get has_systemDataSource() {
            return pb_1.Message.getField(this, 2) != null;
        }
        get systemNamespace() {
            return pb_1.Message.getWrapperField(this, dependency_5.model.Namespace, 3) as dependency_5.model.Namespace;
        }
        set systemNamespace(value: dependency_5.model.Namespace) {
            pb_1.Message.setWrapperField(this, 3, value);
        }
        get has_systemNamespace() {
            return pb_1.Message.getField(this, 3) != null;
        }
        get initDataSources() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.model.DataSource, 4) as dependency_1.model.DataSource[];
        }
        set initDataSources(value: dependency_1.model.DataSource[]) {
            pb_1.Message.setRepeatedWrapperField(this, 4, value);
        }
        get initNamespaces() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_5.model.Namespace, 5) as dependency_5.model.Namespace[];
        }
        set initNamespaces(value: dependency_5.model.Namespace[]) {
            pb_1.Message.setRepeatedWrapperField(this, 5, value);
        }
        get initUsers() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.model.User, 6) as dependency_2.model.User[];
        }
        set initUsers(value: dependency_2.model.User[]) {
            pb_1.Message.setRepeatedWrapperField(this, 6, value);
        }
        get initResources() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.model.Resource, 7) as dependency_3.model.Resource[];
        }
        set initResources(value: dependency_3.model.Resource[]) {
            pb_1.Message.setRepeatedWrapperField(this, 7, value);
        }
        get initRecords() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.model.Record, 8) as dependency_4.model.Record[];
        }
        set initRecords(value: dependency_4.model.Record[]) {
            pb_1.Message.setRepeatedWrapperField(this, 8, value);
        }
        static fromObject(data: {
            config?: ReturnType<typeof AppConfig.prototype.toObject>;
            systemDataSource?: ReturnType<typeof dependency_1.model.DataSource.prototype.toObject>;
            systemNamespace?: ReturnType<typeof dependency_5.model.Namespace.prototype.toObject>;
            initDataSources?: ReturnType<typeof dependency_1.model.DataSource.prototype.toObject>[];
            initNamespaces?: ReturnType<typeof dependency_5.model.Namespace.prototype.toObject>[];
            initUsers?: ReturnType<typeof dependency_2.model.User.prototype.toObject>[];
            initResources?: ReturnType<typeof dependency_3.model.Resource.prototype.toObject>[];
            initRecords?: ReturnType<typeof dependency_4.model.Record.prototype.toObject>[];
        }): InitData {
            ...
            if (data.systemDataSource != null) {
                message.systemDataSource = dependency_1.model.DataSource.fromObject(data.systemDataSource);
            }
            if (data.systemNamespace != null) {
                message.systemNamespace = dependency_5.model.Namespace.fromObject(data.systemNamespace);
            }
            if (data.initDataSources != null) {
                message.initDataSources = data.initDataSources.map(item => dependency_1.model.DataSource.fromObject(item));
            }
            if (data.initNamespaces != null) {
                message.initNamespaces = data.initNamespaces.map(item => dependency_5.model.Namespace.fromObject(item));
            }
            if (data.initUsers != null) {
                message.initUsers = data.initUsers.map(item => dependency_2.model.User.fromObject(item));
            }
            if (data.initResources != null) {
                message.initResources = data.initResources.map(item => dependency_3.model.Resource.fromObject(item));
            }
            if (data.initRecords != null) {
                message.initRecords = data.initRecords.map(item => dependency_4.model.Record.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.initDataSources != null) {
                data.initDataSources = this.initDataSources.map((item: dependency_1.model.DataSource) => item.toObject());
            }
            if (this.initNamespaces != null) {
                data.initNamespaces = this.initNamespaces.map((item: dependency_5.model.Namespace) => item.toObject());
            }
            if (this.initUsers != null) {
                data.initUsers = this.initUsers.map((item: dependency_2.model.User) => item.toObject());
            }
            if (this.initResources != null) {
                data.initResources = this.initResources.map((item: dependency_3.model.Resource) => item.toObject());
            }
            if (this.initRecords != null) {
                data.initRecords = this.initRecords.map((item: dependency_4.model.Record) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_systemDataSource)
                writer.writeMessage(2, this.systemDataSource, () => this.systemDataSource.serialize(writer));
            if (this.has_systemNamespace)
                writer.writeMessage(3, this.systemNamespace, () => this.systemNamespace.serialize(writer));
            if (this.initDataSources.length)
                writer.writeRepeatedMessage(4, this.initDataSources, (item: dependency_1.model.DataSource) => item.serialize(writer));
            if (this.initNamespaces.length)
                writer.writeRepeatedMessage(5, this.initNamespaces, (item: dependency_5.model.Namespace) => item.serialize(writer));
            if (this.initUsers.length)
                writer.writeRepeatedMessage(6, this.initUsers, (item: dependency_2.model.User) => item.serialize(writer));
            if (this.initResources.length)
                writer.writeRepeatedMessage(7, this.initResources, (item: dependency_3.model.Resource) => item.serialize(writer));
            if (this.initRecords.length)
                writer.writeRepeatedMessage(8, this.initRecords, (item: dependency_4.model.Record) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.systemDataSource, () => message.systemDataSource = dependency_1.model.DataSource.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.systemNamespace, () => message.systemNamespace = dependency_5.model.Namespace.deserialize(reader));
                        break;
                    case 4:
                        reader.readMessage(message.initDataSources, () => pb_1.Message.addToRepeatedWrapperField(message, 4, dependency_1.model.DataSource.deserialize(reader), dependency_1.model.DataSource));
                        break;
                    case 5:
                        reader.readMessage(message.initNamespaces, () => pb_1.Message.addToRepeatedWrapperField(message, 5, dependency_5.model.Namespace.deserialize(reader), dependency_5.model.Namespace));
                        break;
                    case 6:
                        reader.readMessage(message.initUsers, () => pb_1.Message.addToRepeatedWrapperField(message, 6, dependency_2.model.User.deserialize(reader), dependency_2.model.User));
                        break;
                    case 7:
                        reader.readMessage(message.initResources, () => pb_1.Message.addToRepeatedWrapperField(message, 7, dependency_3.model.Resource.deserialize(reader), dependency_3.model.Resource));
                        break;
                    case 8:
                        reader.readMessage(message.initRecords, () => pb_1.Message.addToRepeatedWrapperField(message, 8, dependency_4.model.Record.deserialize(reader), dependency_4.model.Record));
                        break;
                    default: reader.skipField();
                }
            }
