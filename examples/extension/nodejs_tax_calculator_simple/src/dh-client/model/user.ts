...
export namespace model {
    export class User extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            details?: dependency_1.google.protobuf.Struct;
            signKey?: string;
            auditData?: dependency_2.model.AuditData;
            version?: number;
        }) {
            super();
        ...
        get securityContext() {
            return pb_1.Message.getWrapperField(this, dependency_4.model.SecurityContext, 5) as dependency_4.model.SecurityContext;
        }
        ...
        get details() {
            return pb_1.Message.getWrapperField(this, dependency_1.google.protobuf.Struct, 6) as dependency_1.google.protobuf.Struct;
        }
        set details(value: dependency_1.google.protobuf.Struct) {
        ...
        get auditData() {
            return pb_1.Message.getWrapperField(this, dependency_2.model.AuditData, 101) as dependency_2.model.AuditData;
        }
        set auditData(value: dependency_2.model.AuditData) {
        ...
        static fromObject(data: {
            ...
            details?: ReturnType<typeof dependency_1.google.protobuf.Struct.prototype.toObject>;
            signKey?: string;
            auditData?: ReturnType<typeof dependency_2.model.AuditData.prototype.toObject>;
            version?: number;
        }): User {
            ...
            if (data.details != null) {
                message.details = dependency_1.google.protobuf.Struct.fromObject(data.details);
            }
            if (data.signKey != null) {
                message.signKey = data.signKey;
            }
            if (data.auditData != null) {
                message.auditData = dependency_2.model.AuditData.fromObject(data.auditData);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        reader.readMessage(message.details, () => message.details = dependency_1.google.protobuf.Struct.deserialize(reader));
                        break;
                    case 7:
                        message.signKey = reader.readString();
                        break;
                    case 101:
                        reader.readMessage(message.auditData, () => message.auditData = dependency_2.model.AuditData.deserialize(reader));
                        break;
                    case 102:
