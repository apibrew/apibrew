...
export namespace model {
    ...
    export class VirtualParams extends pb_1.Message {
        ...
        get mode() {
            return pb_1.Message.getFieldWithDefault(this, 1, VirtualParams.Mode.DISCARD) as VirtualParams.Mode;
        }
        set mode(value: VirtualParams.Mode) {
            pb_1.Message.setField(this, 1, value);
        }
        static fromObject(data: {
            mode?: VirtualParams.Mode;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.mode != VirtualParams.Mode.DISCARD)
