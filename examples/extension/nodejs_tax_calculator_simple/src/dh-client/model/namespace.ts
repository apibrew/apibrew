...
export namespace model {
    export class Namespace extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            name?: string;
            description?: string;
            details?: dependency_4.google.protobuf.Struct;
            securityContext?: dependency_3.model.SecurityContext;
        ...
        get details() {
            return pb_1.Message.getWrapperField(this, dependency_4.google.protobuf.Struct, 5) as dependency_4.google.protobuf.Struct;
        }
        set details(value: dependency_4.google.protobuf.Struct) {
        ...
        get securityContext() {
            return pb_1.Message.getWrapperField(this, dependency_3.model.SecurityContext, 6) as dependency_3.model.SecurityContext;
        }
        set securityContext(value: dependency_3.model.SecurityContext) {
        ...
        static fromObject(data: {
            ...
            name?: string;
            description?: string;
            details?: ReturnType<typeof dependency_4.google.protobuf.Struct.prototype.toObject>;
            securityContext?: ReturnType<typeof dependency_3.model.SecurityContext.prototype.toObject>;
            ...
            if (data.details != null) {
                message.details = dependency_4.google.protobuf.Struct.fromObject(data.details);
            }
            if (data.securityContext != null) {
                message.securityContext = dependency_3.model.SecurityContext.fromObject(data.securityContext);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.details, () => message.details = dependency_4.google.protobuf.Struct.deserialize(reader));
                        break;
                    case 6:
                        reader.readMessage(message.securityContext, () => message.securityContext = dependency_3.model.SecurityContext.deserialize(reader));
                        break;
                    case 101:
