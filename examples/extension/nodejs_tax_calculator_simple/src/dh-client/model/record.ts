...
export namespace model {
    export class Record extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            id?: string;
            properties?: Map<string, dependency_1.google.protobuf.Value>;
            propertiesPacked?: dependency_1.google.protobuf.Value[];
        }) {
            super();
        ...
        set properties(value: Map<string, dependency_1.google.protobuf.Value>) {
            pb_1.Message.setField(this, 4, value as any);
        }
        get propertiesPacked() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.google.protobuf.Value, 5) as dependency_1.google.protobuf.Value[];
        }
        set propertiesPacked(value: dependency_1.google.protobuf.Value[]) {
        ...
        static fromObject(data: {
            ...
            propertiesPacked?: ReturnType<typeof dependency_1.google.protobuf.Value.prototype.toObject>[];
        }): Record {
            ...
            if (typeof data.properties == "object") {
                message.properties = new Map(Object.entries(data.properties).map(([key, value]) => [key, dependency_1.google.protobuf.Value.fromObject(value)]));
            }
            if (data.propertiesPacked != null) {
                message.propertiesPacked = data.propertiesPacked.map(item => dependency_1.google.protobuf.Value.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.propertiesPacked != null) {
                data.propertiesPacked = this.propertiesPacked.map((item: dependency_1.google.protobuf.Value) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.propertiesPacked.length)
                writer.writeRepeatedMessage(5, this.propertiesPacked, (item: dependency_1.google.protobuf.Value) => item.serialize(writer));
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.propertiesPacked, () => pb_1.Message.addToRepeatedWrapperField(message, 5, dependency_1.google.protobuf.Value.deserialize(reader), dependency_1.google.protobuf.Value));
                        break;
