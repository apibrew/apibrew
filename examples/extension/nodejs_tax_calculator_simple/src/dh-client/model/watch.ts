...
export namespace model {
    ...
    export class WatchMessage extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            changes?: dependency_1.google.protobuf.Struct;
            recordIds?: string[];
            event?: EventType;
            event_on?: dependency_2.google.protobuf.Timestamp;
        }) {
            super();
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("event_on" in data && data.event_on != undefined) {
        ...
        set changes(value: dependency_1.google.protobuf.Struct) {
        ...
        set event_on(value: dependency_2.google.protobuf.Timestamp) {
        ...
        static fromObject(data: {
            changes?: ReturnType<typeof dependency_1.google.protobuf.Struct.prototype.toObject>;
            recordIds?: string[];
            event?: EventType;
            event_on?: ReturnType<typeof dependency_2.google.protobuf.Timestamp.prototype.toObject>;
        }): WatchMessage {
            const message = new WatchMessage({});
            if (data.changes != null) {
                message.changes = dependency_1.google.protobuf.Struct.fromObject(data.changes);
            }
            ...
            if (data.event_on != null) {
                message.event_on = dependency_2.google.protobuf.Timestamp.fromObject(data.event_on);
            }
            return message;
        }
        toObject() {
            ...
            if (this.event_on != null) {
                data.event_on = this.event_on.toObject();
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_event_on)
                writer.writeMessage(3, this.event_on, () => this.event_on.serialize(writer));
            if (!w)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): WatchMessage {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 4:
                        reader.readMessage(message.changes, () => message.changes = dependency_1.google.protobuf.Struct.deserialize(reader));
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.event_on, () => message.event_on = dependency_2.google.protobuf.Timestamp.deserialize(reader));
                        break;
