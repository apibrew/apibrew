...
export namespace model {
    ...
    export class RefValue extends pb_1.Message {
        ...
        get properties() {
            return pb_1.Message.getField(this, 3) as any as Map<string, dependency_1.google.protobuf.Value>;
        }
    ...
    export class Expression extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            ...
            property?: never;
            value?: dependency_1.google.protobuf.Value;
            refValue?: never;
        } | {
            property?: never;
            value?: never;
        ...
        get value() {
            return pb_1.Message.getWrapperField(this, dependency_1.google.protobuf.Value, 3) as dependency_1.google.protobuf.Value;
        }
        set value(value: dependency_1.google.protobuf.Value) {
        ...
        static fromObject(data: {
            property?: string;
            value?: ReturnType<typeof dependency_1.google.protobuf.Value.prototype.toObject>;
            ...
            if (data.value != null) {
                message.value = dependency_1.google.protobuf.Value.fromObject(data.value);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.value, () => message.value = dependency_1.google.protobuf.Value.deserialize(reader));
                        break;
                    case 4:
