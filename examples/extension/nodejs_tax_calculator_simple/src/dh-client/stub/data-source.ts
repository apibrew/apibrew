...
export namespace stub {
    ...
    export class PrepareResourceFromEntityResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            resource?: dependency_3.model.Resource;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get resource() {
            return pb_1.Message.getWrapperField(this, dependency_3.model.Resource, 1) as dependency_3.model.Resource;
        }
        set resource(value: dependency_3.model.Resource) {
        ...
        static fromObject(data: {
            resource?: ReturnType<typeof dependency_3.model.Resource.prototype.toObject>;
        }): PrepareResourceFromEntityResponse {
            const message = new PrepareResourceFromEntityResponse({});
            if (data.resource != null) {
                message.resource = dependency_3.model.Resource.fromObject(data.resource);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PrepareResourceFromEntityResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.resource, () => message.resource = dependency_3.model.Resource.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class ListEntitiesResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            catalogs?: dependency_1.model.DataSourceCatalog[];
        }) {
            super();
        ...
        get catalogs() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.model.DataSourceCatalog, 1) as dependency_1.model.DataSourceCatalog[];
        }
        set catalogs(value: dependency_1.model.DataSourceCatalog[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            catalogs?: ReturnType<typeof dependency_1.model.DataSourceCatalog.prototype.toObject>[];
        }): ListEntitiesResponse {
            const message = new ListEntitiesResponse({});
            if (data.catalogs != null) {
                message.catalogs = data.catalogs.map(item => dependency_1.model.DataSourceCatalog.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.catalogs != null) {
                data.catalogs = this.catalogs.map((item: dependency_1.model.DataSourceCatalog) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.catalogs.length)
                writer.writeRepeatedMessage(1, this.catalogs, (item: dependency_1.model.DataSourceCatalog) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ListEntitiesResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.catalogs, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_1.model.DataSourceCatalog.deserialize(reader), dependency_1.model.DataSourceCatalog));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class ListDataSourceResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            content?: dependency_1.model.DataSource[];
        }) {
            super();
        ...
        get content() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.model.DataSource, 2) as dependency_1.model.DataSource[];
        }
        set content(value: dependency_1.model.DataSource[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        static fromObject(data: {
            content?: ReturnType<typeof dependency_1.model.DataSource.prototype.toObject>[];
        }): ListDataSourceResponse {
            const message = new ListDataSourceResponse({});
            if (data.content != null) {
                message.content = data.content.map(item => dependency_1.model.DataSource.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.content != null) {
                data.content = this.content.map((item: dependency_1.model.DataSource) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.content.length)
                writer.writeRepeatedMessage(2, this.content, (item: dependency_1.model.DataSource) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ListDataSourceResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 2:
                        reader.readMessage(message.content, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.model.DataSource.deserialize(reader), dependency_1.model.DataSource));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class CreateDataSourceRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            token?: string;
            dataSources?: dependency_1.model.DataSource[];
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        set dataSources(value: dependency_1.model.DataSource[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        static fromObject(data: {
            token?: string;
            dataSources?: ReturnType<typeof dependency_1.model.DataSource.prototype.toObject>[];
            ...
            if (data.dataSources != null) {
                message.dataSources = data.dataSources.map(item => dependency_1.model.DataSource.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.dataSources != null) {
                data.dataSources = this.dataSources.map((item: dependency_1.model.DataSource) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.dataSources.length)
                writer.writeRepeatedMessage(2, this.dataSources, (item: dependency_1.model.DataSource) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.dataSources, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.model.DataSource.deserialize(reader), dependency_1.model.DataSource));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class CreateDataSourceResponse extends pb_1.Message {
        ...
        get dataSources() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.model.DataSource, 1) as dependency_1.model.DataSource[];
        }
        set dataSources(value: dependency_1.model.DataSource[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.dataSources.length)
                writer.writeRepeatedMessage(1, this.dataSources, (item: dependency_1.model.DataSource) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreateDataSourceResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.dataSources, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_1.model.DataSource.deserialize(reader), dependency_1.model.DataSource));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class GetDataSourceResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            dataSource?: dependency_1.model.DataSource;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get dataSource() {
            return pb_1.Message.getWrapperField(this, dependency_1.model.DataSource, 1) as dependency_1.model.DataSource;
        }
        set dataSource(value: dependency_1.model.DataSource) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_dataSource() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            dataSource?: ReturnType<typeof dependency_1.model.DataSource.prototype.toObject>;
        }): GetDataSourceResponse {
            const message = new GetDataSourceResponse({});
            if (data.dataSource != null) {
                message.dataSource = dependency_1.model.DataSource.fromObject(data.dataSource);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetDataSourceResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.dataSource, () => message.dataSource = dependency_1.model.DataSource.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
