...
export namespace stub {
    ...
    export class ListExtensionResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            content?: dependency_3.model.Extension[];
        }) {
            super();
        ...
        get content() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.model.Extension, 1) as dependency_3.model.Extension[];
        }
        set content(value: dependency_3.model.Extension[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            content?: ReturnType<typeof dependency_3.model.Extension.prototype.toObject>[];
        }): ListExtensionResponse {
            const message = new ListExtensionResponse({});
            if (data.content != null) {
                message.content = data.content.map(item => dependency_3.model.Extension.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.content != null) {
                data.content = this.content.map((item: dependency_3.model.Extension) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.content.length)
                writer.writeRepeatedMessage(1, this.content, (item: dependency_3.model.Extension) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ListExtensionResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.content, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.model.Extension.deserialize(reader), dependency_3.model.Extension));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class GetExtensionResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            extension?: dependency_3.model.Extension;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get extension() {
            return pb_1.Message.getWrapperField(this, dependency_3.model.Extension, 1) as dependency_3.model.Extension;
        }
        set extension(value: dependency_3.model.Extension) {
        ...
        static fromObject(data: {
            extension?: ReturnType<typeof dependency_3.model.Extension.prototype.toObject>;
        }): GetExtensionResponse {
            const message = new GetExtensionResponse({});
            if (data.extension != null) {
                message.extension = dependency_3.model.Extension.fromObject(data.extension);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetExtensionResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.extension, () => message.extension = dependency_3.model.Extension.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class CreateExtensionRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            token?: string;
            extensions?: dependency_3.model.Extension[];
        }) {
            super();
        ...
        get extensions() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.model.Extension, 2) as dependency_3.model.Extension[];
        }
        set extensions(value: dependency_3.model.Extension[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        static fromObject(data: {
            token?: string;
            extensions?: ReturnType<typeof dependency_3.model.Extension.prototype.toObject>[];
            ...
            if (data.extensions != null) {
                message.extensions = data.extensions.map(item => dependency_3.model.Extension.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.extensions != null) {
                data.extensions = this.extensions.map((item: dependency_3.model.Extension) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.extensions.length)
                writer.writeRepeatedMessage(2, this.extensions, (item: dependency_3.model.Extension) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.extensions, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_3.model.Extension.deserialize(reader), dependency_3.model.Extension));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class CreateExtensionResponse extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.extensions.length)
                writer.writeRepeatedMessage(1, this.extensions, (item: dependency_3.model.Extension) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreateExtensionResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.extensions, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.model.Extension.deserialize(reader), dependency_3.model.Extension));
                        break;
                    default: reader.skipField();
                }
            }
