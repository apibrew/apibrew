...
export class AuthenticationRequest extends pb_1.Message {
    ...
    get term() {
        return pb_1.Message.getFieldWithDefault(this, 3, dependency_2.TokenTerm.SHORT) as dependency_2.TokenTerm;
    }
    set term(value: dependency_2.TokenTerm) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.term != dependency_2.TokenTerm.SHORT)
...
export class AuthenticationResponse extends pb_1.Message {
    ...
    get token() {
        return pb_1.Message.getWrapperField(this, dependency_2.Token, 1) as dependency_2.Token;
    }
    set token(value: dependency_2.Token) {
    ...
    static fromObject(data: {
        token?: ReturnType<typeof dependency_2.Token.prototype.toObject>;
    }): AuthenticationResponse {
        const message = new AuthenticationResponse({});
        if (data.token != null) {
            message.token = dependency_2.Token.fromObject(data.token);
        }
        return message;
    }
    toObject() {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AuthenticationResponse {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.token, () => message.token = dependency_2.Token.deserialize(reader));
                    break;
                default: reader.skipField();
            }
        }
...
export class RenewTokenRequest extends pb_1.Message {
    ...
    get term() {
        return pb_1.Message.getFieldWithDefault(this, 2, dependency_2.TokenTerm.SHORT) as dependency_2.TokenTerm;
    }
    set term(value: dependency_2.TokenTerm) {
        pb_1.Message.setField(this, 2, value);
    }
