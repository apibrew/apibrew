...
export namespace stub {
    export class PrepareResourceMigrationPlanRequest extends pb_1.Message {
        ...
        get resources() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.model.Resource, 3) as dependency_2.model.Resource[];
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.resources.length)
                writer.writeRepeatedMessage(3, this.resources, (item: dependency_2.model.Resource) => item.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.resources, () => pb_1.Message.addToRepeatedWrapperField(message, 3, dependency_2.model.Resource.deserialize(reader), dependency_2.model.Resource));
                        break;
                    case 103:
    ...
    export class PrepareResourceMigrationPlanResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            plans?: dependency_3.model.ResourceMigrationPlan[];
        }) {
            super();
        ...
        get plans() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.model.ResourceMigrationPlan, 1) as dependency_3.model.ResourceMigrationPlan[];
        }
        set plans(value: dependency_3.model.ResourceMigrationPlan[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            plans?: ReturnType<typeof dependency_3.model.ResourceMigrationPlan.prototype.toObject>[];
        }): PrepareResourceMigrationPlanResponse {
            const message = new PrepareResourceMigrationPlanResponse({});
            if (data.plans != null) {
                message.plans = data.plans.map(item => dependency_3.model.ResourceMigrationPlan.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.plans != null) {
                data.plans = this.plans.map((item: dependency_3.model.ResourceMigrationPlan) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.plans.length)
                writer.writeRepeatedMessage(1, this.plans, (item: dependency_3.model.ResourceMigrationPlan) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PrepareResourceMigrationPlanResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.plans, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.model.ResourceMigrationPlan.deserialize(reader), dependency_3.model.ResourceMigrationPlan));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class CreateResourceResponse extends pb_1.Message {
        ...
        get resources() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.model.Resource, 1) as dependency_2.model.Resource[];
        }
        set resources(value: dependency_2.model.Resource[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.resources.length)
                writer.writeRepeatedMessage(1, this.resources, (item: dependency_2.model.Resource) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CreateResourceResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.resources, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_2.model.Resource.deserialize(reader), dependency_2.model.Resource));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class GetResourceResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            resource?: dependency_2.model.Resource;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        set resource(value: dependency_2.model.Resource) {
        ...
        static fromObject(data: {
            resource?: ReturnType<typeof dependency_2.model.Resource.prototype.toObject>;
        }): GetResourceResponse {
            const message = new GetResourceResponse({});
            if (data.resource != null) {
                message.resource = dependency_2.model.Resource.fromObject(data.resource);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetResourceResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.resource, () => message.resource = dependency_2.model.Resource.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
