...
type CronJobMapper struct {
}

func NewCronJobMapper() *CronJobMapper {
	return &CronJobMapper{}
}

var CronJobMapperInstance = NewCronJobMapper()

func (m *CronJobMapper) New() *CronJob {
	return &CronJob{}
}

func (m *CronJobMapper) ResourceIdentity() abs.ResourceIdentity {
...
func (m *CronJobMapper) ToRecord(cronJob *CronJob) *model.Record {
	var rec = &model.Record{}
	rec.Properties = m.ToProperties(cronJob)
	return rec
}

func (m *CronJobMapper) FromRecord(record *model.Record) *CronJob {
	return m.FromProperties(record.Properties)
}

func (m *CronJobMapper) ToProperties(cronJob *CronJob) map[string]*structpb.Value {
	...
	var_AuditData := cronJob.AuditData

	if var_AuditData != nil {
		var var_AuditData_mapped *structpb.Value

		var_AuditData_mapped = structpb.NewStructValue(&structpb.Struct{Fields: CronJobAuditDataMapperInstance.ToProperties(var_AuditData)})
		properties["auditData"] = var_AuditData_mapped
	}
	return properties
}

func (m *CronJobMapper) FromProperties(properties map[string]*structpb.Value) *CronJob {
	var s = m.New()
	...
	if properties["auditData"] != nil && properties["auditData"].AsInterface() != nil {
		...
		var mappedValue = CronJobAuditDataMapperInstance.FromProperties(var_AuditData.GetStructValue().Fields)
...
func (m *CronJobMapper) ToUnstructured(cronJob *CronJob) unstructured.Unstructured {
	...
	if var_AuditData != nil {
		...
		var_AuditData_mapped = CronJobAuditDataMapperInstance.ToUnstructured(var_AuditData)
		properties["auditData"] = var_AuditData_mapped
	}
...
type CronJobAuditDataMapper struct {
}

func NewCronJobAuditDataMapper() *CronJobAuditDataMapper {
	return &CronJobAuditDataMapper{}
}

var CronJobAuditDataMapperInstance = NewCronJobAuditDataMapper()

func (m *CronJobAuditDataMapper) New() *CronJobAuditData {
	return &CronJobAuditData{}
}

func (m *CronJobAuditDataMapper) ResourceIdentity() abs.ResourceIdentity {
	return abs.ResourceIdentity{
		Namespace: "nano",
		Name:      "CronJob",
	}
...
func (m *CronJobAuditDataMapper) ToProperties(cronJobAuditData *CronJobAuditData) map[string]*structpb.Value {
	var properties = make(map[string]*structpb.Value)
	...
	var_UpdatedBy := cronJobAuditData.UpdatedBy
	...
	var_CreatedOn := cronJobAuditData.CreatedOn
	...
	var_UpdatedOn := cronJobAuditData.UpdatedOn
...
func (m *CronJobAuditDataMapper) FromProperties(properties map[string]*structpb.Value) *CronJobAuditData {
	var s = m.New()
